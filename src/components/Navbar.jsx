...
import { Menu, X, Trophy, Home, Calendar, Users, User, LogOut, Shield, Globe } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="font-display text-2xl tracking-wider gradient-text">PREDICTION WORLD</span>
          </Link>
