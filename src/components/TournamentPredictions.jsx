...
const TournamentPredictions = ({ tournamentId, tournamentStarted }) => {
  const { user } = useAuth();
    ...
    <div className="mt-8">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="card">
          ...
          {tournamentStarted && !myPrediction?.best_player_id && (
            <p className="text-center text-gray-500 text-sm mt-4">Le tournoi a commencé, les prédictions sont fermées</p>
          )}
        </div>
        ...
        <div className="card">
          ...
          {tournamentStarted && !myPrediction?.best_goal_scorer_id && (
            <p className="text-center text-gray-500 text-sm mt-4">Le tournoi a commencé, les prédictions sont fermées</p>
          )}
        </div>
      </div>
