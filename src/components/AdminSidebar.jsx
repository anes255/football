...
import { LayoutDashboard, Users, Calendar, Flag, Settings, Award, ArrowLeft, Trophy } from 'lucide-react';
  ...
  return (
    <div className="w-64 min-h-screen glass border-r border-white/10 p-4">
      <div className="flex items-center space-x-2 mb-8 px-2">
        ...
        <div><h2 className="font-display text-xl gradient-text">Admin</h2><p className="text-xs text-gray-400">CAN 2025</p></div>
      </div>
