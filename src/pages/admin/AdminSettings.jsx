        ...
        {loading ? <div className="flex items-center justify-center h-64"><div className="animate-spin w-12 h-12 border-4 border-primary-500 border-t-transparent rounded-full" /></div> : (
          <div className="space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="card">
              ...
              <p className="text-gray-400 mb-4">Attribuez les points bonus aux utilisateurs ayant prédit le vainqueur de la CAN</p>
              <div className="flex items-center space-x-4">
                <select value={selectedWinner} onChange={(e) => setSelectedWinner(e.target.value)} className="input flex-1">
                  ...
                  {teams.map(t => <option key={t.id} value={t.id}>{t.flag_url} {t.name}</option>)}
                </select>
